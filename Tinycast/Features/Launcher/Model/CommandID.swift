...
enum CommandID: String, CaseIterable, Sendable {
    ...
    var name: String { untranslatedName.localizedUI }

    /// What upstream calls the command, kept as a search alias: a localized name would otherwise
    /// make `clipboard` stop finding 剪贴板历史.
    var untranslatedName: String {
        switch self {
